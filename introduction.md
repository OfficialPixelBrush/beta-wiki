...
[Beta 1.7.3](https://minecraft.wiki/w/Java_Edition_Beta_1.7.3) is one of the last versions that people consider to be part of Minecrafts "Golden Age", where times between updates were often just a few days or weeks, and the community and scope of the game were much smaller.
...
It depends on who you ask. None of us are laywers, but for all we know we're sitting in a legal grey area that Mojang or Microsoft haven't been bothered by enough just yet.
