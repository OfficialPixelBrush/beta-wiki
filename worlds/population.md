...
| Trees             | -      | _\*[1]_  | `8 - 23` | _\*[2]_    |
| Dandelions        | -      | _\*[1]_  | `8 - 23` | `0 - 127`  |
| Tallgrass         | -      | _\*[1]_  | `8 - 23` | `0 - 127`  |
| Deadbushes        | -      | _\*[1]_  | `8 - 23` | `0 - 127`  |
...
| Cacti             | -      | _\*[1]_  | `8 - 23` | `0 - 127`  |
| SBS (Water)       | -      | `50`     | `8 - 23` | `8 - ~127` |
| SBS (Lava)        | -      | `20`     | `8 - 23` | `8 - ~127` |

- _[1]\* [Biome-dependent](#biome-dependent-attempts)_
- _[2]\* Terrain Height_
...
_The `treeDensity` is taken from the tree density noise, see more about this in the [Tree Generation section](#trees)_
