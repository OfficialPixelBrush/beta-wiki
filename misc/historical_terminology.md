...
| -------------------- | -------------- | ----------------------------------------------------------------------------------------------------- |
| Damage, Damage value | Metadata       | Came about due to how the damange system was introduced for tools, then reused for blocks (like wool) |
| Workbench            | Crafting table | Crafting tables were called Workbenches until Beta 1.2                                                |
| Hatchet              | Axe            | Community name. The proper name was introduced via Tooltips in Beta 1.0                               |
| Not Gate, Diode      | Repeater       | Repeaters can also act as Diodes                                                                      |
| Emeralds             | Diamonds       | Diamonds were called Emeralds in late Classic                                                         |
| Cloth                | Wool           |                                                                                                       |
| Wire                 | Redstone Dust  |                                                                                                       |
