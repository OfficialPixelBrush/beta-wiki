...
| X         | Integer | The X block position of where the effect is played.         |
| Y         | Byte    | The Y block position of where the effect is played.         |
| Z         | Integer | The Z block position of where the effect is played.         |
